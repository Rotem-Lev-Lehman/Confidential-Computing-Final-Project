...
Runs a battery of measurements and writes everything needed for the report:
    ...
    experiments/report.md      the generated report (human-readable)
...
def render_report(res: dict) -> str:
    ...
    add("# Performance report: from-scratch Yao's Garbled Circuits\n")
...
def main() -> int:
    ...
    parser.add_argument("--render-only", action="store_true",
                        help="re-render report.md from the existing results.json")
